    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert(appdata v)
            {
                ...
                // Wave animation based on vertex height
                float wave = sin((_WaveFrequency * v.vertex.y) + (_WaveSpeed * _Time.y)) * _WaveAmplitude;
                
                // Apply wave offset to X and Z axes
                v.vertex.x += wave * 0.5;
                v.vertex.z += wave * 0.3;
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                // Cel shading - discretize the lighting
